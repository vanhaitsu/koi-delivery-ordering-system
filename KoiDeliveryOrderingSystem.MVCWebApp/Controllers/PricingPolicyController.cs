...
namespace KoiDeliveryOrderingSystem.MVCWebApp.Controllers
{
    public class PricingPolicyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PricingId,WeightRange,ShippingMethod,BasePrice,AdditionalServicePrice,InsuranceFee,CustomsFee,Currency,EffectiveDate,ExpiryDate")] Models.PricingPolicy pricingPolicy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PricingId,WeightRange,ShippingMethod,BasePrice,AdditionalServicePrice,InsuranceFee,CustomsFee,Currency,EffectiveDate,ExpiryDate")] Models.PricingPolicy pricingPolicy)
        {
